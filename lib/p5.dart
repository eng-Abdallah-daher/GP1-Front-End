...
class NotificationsPage extends StatelessWidget {
    ...
    return Scaffold(
      body: SingleChildScrollView(
        child: Container(
          ...
          child: Padding(
            padding: const EdgeInsets.only(top: 35, bottom: 38, right: 16, left: 16),
            child: Column(
  ...
  child: Image.asset(
    'images/logo6.png', // Update with your image path
    width: 500, // Adjust width as needed
                ...
                ElevatedButton(
                  onPressed: () {
                    // Handle navigation to home or other action
                    print("Go to Home button pressed");
                    // Navigator.pushNamed(context, '/home'); // Uncomment when navigation is set up
                  },
