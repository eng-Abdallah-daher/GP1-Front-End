...
class MapService {
  final String apiKey =
      '5b3ce3597851110001cf62482a1520537959448fb30c5526d252e996'; // Your actual API key
...
class _MapScreenState extends State<MapScreen> {
  ...
  Marker? lastTappedMarker; // Track the last tapped marker
  final TextEditingController _searchController = TextEditingController();
  String placeDetails = ''; // To store place details
...
void _findNearby(String amenity) async {
    if (currentLocation != null) {
      ...
      if (response.statusCode == 200) {
        ...
        // Calculate distances and sort elements by distance
        ...
        // Get the closest result if available
...
void _startListening() async {
  ...
  await _speech.listen(onResult: (result) {
    setState(() {
      ...
      _searchController.text = _lastWords; // Update search field text
    });
